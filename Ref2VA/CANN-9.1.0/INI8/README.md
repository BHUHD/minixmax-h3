...
1. 准备ComfyUI版本的Ref2VA权重（只读挂载）：

```text
models/ComfyUI/INI8/Ref2VA/
├── diffusion_models/minimax_h3_ref2va_pruned_int8_convrot.safetensors
├── text_encoders/qwen3vl_32b_minimax_h3_nvfp4_awq.safetensors
└── vae/{minimax_h3_video_vae_fp16,minimax_h3_audio_vae_fp32}.safetensors
```

1. 镜像：`nuvic/minimax-h3:ref2va-cann9.1.0-int8-v1.1`
2. 在仓库根目录：
...
停止：`docker compose -f Ref2VA/CANN-9.1.0/INI8/docker-compose-v1.1.yml down`
...
复现：`python3 Ref2VA/CANN-9.1.0/INI8/scripts/bench_ref_matrix.py --only all` → `tmp/bench_npu_v1.1/summary.md`。
